...
extension CK550Command {
    ...
    enum OffEffectHeartbeatSpeed: uint8 {
    ...
    static var setOffEffectHeartbeatUNKNOWN_BEFORE_PACKETS: [uint8] {
        get {
    ...
    static func setOffEffectHeartbeat(background: RGBColor, key: RGBColor?, speed: OffEffectHeartbeatSpeed) -> [[uint8]] {
        var result: [[uint8]] = [
