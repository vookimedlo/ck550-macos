...
extension CK550Command {
    ...
    enum OffEffectFireballSpeed: uint8 {
    ...
    static var setOffEffectFireballUNKNOWN_BEFORE_PACKETS: [uint8] {
        get {
    ...
    static func setOffEffectFireball(background: RGBColor, key: RGBColor?, speed: OffEffectFireballSpeed) -> [[uint8]] {
        var result: [[uint8]] = [
